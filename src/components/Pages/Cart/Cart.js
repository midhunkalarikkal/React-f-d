  ...
  return (
    <div className="flex flex-col w-10/12 md:w-6/12 m-auto">
      <div className="flex justify-between p-3 rounded-lg bg-slate-100 m-3 shadow-lg">
        <div className="flex">
          <h4 className="font-bold text-md md:text-lg">Your Cart Items</h4>
        </div>
        <div className="flex align-middle">
          <button className="text-sm md:text-lg p-1 px-3 bg-red-500 rounded-lg text-white" onClick={handleClearCart}>
            Clear cart
          </button>
        </div>
      </div>
      <div className="p-3">
        ...
        <div className="max-w-md text-center bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-lg md:text-2xl font-semibold text-gray-800 mb-2">Your Cart is Empty</h2>
      ...
      { cartItems.length > 0 && (
        <div className="flex justify-between p-3 rounded-lg bg-slate-100 m-3 mt-0 flex-col md:flex-row">
        <div className="flex">
          <h4 className="font-bold text-md md:text-lg hidden md:block">Confirm your order</h4>
        </div>
        <div className="flex justify-end w-full md:w-auto mt-2 md:mt-0">
          <button className="text-sm md:text-lg p-1 px-3 bg-green-500 rounded-lg text-white w-full md:w-auto" onClick={moveToPayment}>
            Proceed to payment
          </button>
        </div>
      </div>
